            ...
            <div className="bg-[#111b21] w-full max-w-[320px] rounded-[32px] shadow-2xl overflow-hidden flex flex-col border border-[#222e35] pb-8 pt-4 relative">
                ...
                <div className="flex justify-center w-full px-6">
                    <button 
                        onClick={handleCall}
                        disabled={!number}
                        className={`w-20 h-20 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-105 active:scale-95 ${number ? 'bg-[#F97316] hover:bg-[#EA6C0A] text-white shadow-[#F97316]/20' : 'bg-[#1F2937] text-[#aebac1] opacity-50 cursor-not-allowed'}`}
                    >
