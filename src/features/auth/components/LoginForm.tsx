    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                {error && (
                    <div className="bg-red-50 border border-red-100 text-red-655 px-4 py-3 rounded-lg text-sm font-medium animate-in fade-in slide-in-from-top-1 space-y-2">
                        ...
                        {isBanned && (
                            <button
                                ...
                                className="w-full text-center py-2.5 bg-red-650 hover:bg-red-700 text-gray font-bold rounded-lg text-xs transition-all mt-2 cursor-pointer shadow-sm hover:shadow-md active:scale-[0.98] border-none"
                            >
