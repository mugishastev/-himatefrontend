                            ...
                            <div className={`mt-1.5 rounded-md overflow-hidden ${message.type === 'FILE' ? '' : 'bg-black/5'}`}>
                                ...
                                {message.type === "FILE" && (
                                    <div className={`flex items-center gap-3 p-3 rounded-md ${isOwn ? 'bg-black/5' : 'bg-brand/5'}`}>
                                        <div className={`p-3 rounded-lg flex items-center justify-center ${isOwn ? 'bg-[#EA6C0A]/10' : 'bg-brand/10'}`}>
                                            <svg className={`w-6 h-6 ${isOwn ? 'text-[#EA6C0A]' : 'text-brand'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a
                                            ...
                                            className={`w-10 h-10 shrink-0 rounded-full flex items-center justify-center transition-colors border ${isOwn ? 'border-[#EA6C0A]/20 hover:bg-[#EA6C0A]/10 text-[#EA6C0A]' : 'border-brand/20 hover:bg-brand/10 text-brand'}`}
                                        >
