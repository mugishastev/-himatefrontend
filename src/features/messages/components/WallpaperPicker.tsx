                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-5 gap-3">
                        {WALLPAPER_OPTIONS.map(w => (
                            <button
                                ...
                                className={`relative aspect-square rounded-xl overflow-hidden transition-all duration-150 ring-2 ${currentId === w.id ? 'ring-[#F97316] scale-105' : 'ring-transparent hover:scale-105'}`}
                        ...
                        <button
                            ...
                            className={`aspect-square rounded-xl border-2 border-dashed border-[#2a3942] flex flex-col items-center justify-center gap-1 hover:border-[#F97316] hover:text-[#F97316] text-[#8696a0] transition-all hover:scale-105 ${currentId === 'custom' ? 'border-[#F97316] text-[#F97316]' : ''}`}
                        >
